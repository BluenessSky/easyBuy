            ...
            <div class="list_c">
                <ul class="cate_list">
                    <c:forEach items="${productList}" var="temp">
                        <li>
                            <div class="img">
                                <a href="http://localhost:8082/item/queryProductDeatil?id=${temp.id}" target="_blank">
                               		<%-- <a href="http://localhost:81/${temp.id}.html" target="_blank"> --%>
                                    <img src="${temp.filename}" width="210" height="185"/>
                                 </a>
                            </div>
                            <div class="price">
                                <font>￥<span>${temp.price}</span></font>
                            </div>
                            <div class="name"><a href="http://localhost:8082/item/queryProductDeatil?id=${temp.id}">${temp.name}</a></div>
                            <div class="carbg">
