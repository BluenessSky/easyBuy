        ...
        <div class="car_bg">
            ...
            <ul class="cars">
                <c:forEach items="${sessionScope.cart.items}" var="temp">
                    <li>
                        <div class="img"><a href="queryProductDeatil?id=${temp.product.id}"><img src="${ctx}/files/${temp.product.fileName}" width="58" height="58" /></a></div>
                        <div class="name"><a href="queryProductDeatil&id=${temp.product.id}">${temp.product.name}</a></div>
