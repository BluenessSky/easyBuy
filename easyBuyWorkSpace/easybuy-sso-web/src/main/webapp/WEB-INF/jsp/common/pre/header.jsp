    ...
    <!--Begin 所在收货地区 Begin-->
        ...
        <span class="fr">
          <c:if test="${sessionScope.loginUser==null}">
            <span class="fl">你好，请<a href="login"  style="color:#ff4e00;">登录</a>&nbsp;<a href="register" style="color:#ff4e00;">免费注册</a>&nbsp;&nbsp;</span>
          </c:if>
          <c:if test="${sessionScope.loginUser!=null}">
...
<script type="text/javascript" src="${ctx}/statics/js/register/jquery-1.8.3.js"></script>
