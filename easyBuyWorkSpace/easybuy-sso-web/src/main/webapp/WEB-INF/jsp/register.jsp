...
<head>
    ...
    <script type="text/javascript" src="${ctx}/statics/js/register/registerValodate.js"></script>
	<script type="text/javascript" src="${ctx}/statics/js/register/jquery.validate.min.js"></script>
	<script type="text/javascript" src="${ctx}/statics/js/register/messages_zh.min.js"></script>
</head>
<body>
<!--Begin Login Begin-->
<div class="log_bg">
            ...
            <form id="register" action="/user/register" method="post">
                <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
                    ...
                    <tr height="50">
                        ...
                        <td><input type="password" id="password" value="" name="confirmPassword" class="l_pwd"/></td>
                    </tr>
                    <tr height="50">
                    ...
                    <tr height="50">
                        ...
                        <td><input type="text" value="" id="mobileCode" name="mobileCode"/>
                        	<input type="button" value="请输入验证码" id="sendMessageBtn" />
                        </td>
                    </tr>
                    <tr height="60">
                        <td>&nbsp;</td>
                        <td>
                        	<!-- <input type="button" value="立即注册" class="log_btn" onclick="register();"/> -->
