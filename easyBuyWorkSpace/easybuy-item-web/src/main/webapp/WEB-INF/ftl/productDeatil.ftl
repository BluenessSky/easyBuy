...
<head>
    ...
    <script type="text/javascript" src="statics/js/easybuy.js"></script>
    <title>易买网</title>
</head>
<body>
<!--Begin Header Begin-->
<div id="searchBar">
    <#include "common/pre/searchBar.ftl" />
</div>
<!--Begin Header Begin-->
<!--End Header End-->
<!--Begin Menu Begin-->
<div class="menu_bg">
    <div class="menu">
        <!--Begin 商品分类详情 Begin-->
        <#include "common/pre/categoryBar.ftl" />
        <!--End 商品分类详情 End-->
    </div>
</div>
<!--End Menu End-->
<div class="i_bg">
    ...
    <div class="content">
        <div id="tsShopContainer">
            <div id="tsImgS">
                <a href="${product.filename}" title="Images" class="MagicZoom" id="MagicZoom">
        ...
        <div class="pro_des">
           ...
           <div class="des_price">
            ...
            <div class="des_join">
                ...
                <span class="fl">
                     <img src="statics/images/j_car.png" onclick="addCart();"/>
                </span>
            </div>
        </div>
    </div>
