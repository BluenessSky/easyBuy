...
<div class="soubg">
	<div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl">你好，请<a href="http://localhost:8083/login?url=http://localhost:8080">登录</a>&nbsp; <a href="Regist.html" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
...
<div class="top">
    <div class="logo"><a href="http://localhost:8080"><img src="images/logo.png" /></a></div>
    <div class="search">
    	<form method="get" action="http://localhost:8081/item/search">
        	<input type="text" value="" name="query" class="s_ipt" id="hotkey"/>
       	...
       	$(function(){
       		$("#hotkey").attr("placeholder",key[num]);
       		$("#hotkey").val(key[num])
       	})
       	</script>                      
    	...
    	<div class="banner">    	
            <div class="top_slide_wrap">
                <ul class="slide_box bxslider">
                    ...
                    <li><a href="${big.url}" target="_blank"><img src="${big.pic}" width="740" height="401" /></a></li>
                    </c:forEach> 
                </ul>	
                <!-- <div class="op_btns clearfix">
                    <a href="#" class="op_btn op_prev bx-prev"><span></span></a>
                    <a href="#" class="op_btn op_next bx-next"><span></span></a>
                </div>   -->     
            </div>
        </div>
        <script type="text/javascript">
                            ...
                            <ul class="featureUL">
                                ...
                                <li class="featureBox">
                                    <div class="box">
                                    	<div class="h_icon"><img src="images/hot.png" width="50" height="50" /></div>
                                        <div class="imgbg">
                                        	<a href="http://localhost:8086/seckill/getSecill?seckillId=${seckill.seckillId}"><img src="${seckill.image}" width="160" height="136" /></a>
                                        </div>                                        
                                        <div class="name">
                                        	<a href="#">
                                            <h2>${seckill.name}</h2>
                                        ...
                                        <div class="price">
                                            <font>￥<span>${seckill.newPrice }</span></font> &nbsp; ${seckill.oldPirce}
                                        </div>
                                    </div>
                                </li>
                                </c:forEach>
